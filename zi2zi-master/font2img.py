...
from importlib import reload # note: added
reload(sys)
...
parser.add_argument('--char_size', dest='char_size', type=int, default=32, help='character size')
parser.add_argument('--canvas_size', dest='canvas_size', type=int, default=64, help='canvas size')
parser.add_argument('--x_offset', dest='x_offset', type=int, default=16, help='x offset')
...
# https://zhuanlan.zhihu.com/p/63430681
