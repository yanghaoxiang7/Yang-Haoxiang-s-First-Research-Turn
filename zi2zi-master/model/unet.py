...
class UNet(object):
    def __init__(self, experiment_dir=None, experiment_id=0, batch_size=16, input_width=64, output_width=64,
                 generator_dim=16, discriminator_dim=16, L1_penalty=100, Lconst_penalty=15, Ltv_penalty=0.0,
                 Lcategory_penalty=1.0, embedding_num=10, embedding_dim=32, input_filters=3, output_filters=3):
    ...
    def decoder(self, encoded, encoding_layers, ids, inst_norm, is_training, reuse=False):
        with tf.variable_scope("generator"):
            ...
            d1 = decode_layer(encoded, s32, self.generator_dim * 8, layer=1, enc_layer=encoding_layers["e5"],
                             dropout=True)
            d2 = decode_layer(d1, s16, self.generator_dim * 8, layer=2, enc_layer=encoding_layers["e4"], dropout=True)
            ...
            d5 = decode_layer(d4, s2, self.generator_dim, layer=5, enc_layer=encoding_layers["e1"])
